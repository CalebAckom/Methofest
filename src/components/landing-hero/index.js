    ...
    return (
        <div className='landing-hero'>
            <div className='upper-layer'>
                ...
                <div>
                    <h1 className='landing-title-text'>CONNEXIONAL METHOFEST 2023</h1>
                    <h1 className='landing-directions-text'>DIRECTIONS TO BRANCH</h1>
                    <h1 className='landing-footer-text'>THE METHODIST CHURCH GHANA</h1>
                </div>
            </div>
